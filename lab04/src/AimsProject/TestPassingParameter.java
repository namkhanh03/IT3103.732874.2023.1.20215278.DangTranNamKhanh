...
public class TestPassingParameter {
    ...
    public static void main(String[] args) {
        ...
        DigitalVideoDisc jungleDVD = new DigitalVideoDisc(7,"Jungle");
        DigitalVideoDisc cinderellaDVD = new DigitalVideoDisc(8,"Cinderella");
    ...
    public static void changeTitle(DigitalVideoDisc disc, String title){
        ...
        disc.setTitle(title);
        disc = new DigitalVideoDisc(disc.getId(), oldTitle);
    }
