...
import AimsProject.exception.PlayerException;
...
public class Aims {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Adding DVDs
        Media dvd1 = new AimsProject.media.DigitalVideoDisc(1, "Inception",
                "Science Fiction", "Christopher Nolan", 148, 19.99f);
        store.addMedia(dvd1);

        Media dvd2 = new AimsProject.media.DigitalVideoDisc(2, "The Dark Knight",
